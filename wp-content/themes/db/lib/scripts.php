...
function roots_scripts() {
  wp_enqueue_style('roots_theme', get_template_directory_uri() . '/assets/css/theme.css', false, null);
  ...
  if (!is_admin() && current_theme_supports('jquery-cdn')) {
    ...
    wp_register_script('jquery-migrate', '//code.jquery.com/jquery-migrate-1.2.1.min.js', false, null, false);
...
<?php }
if (GOOGLE_ANALYTICS_ID && WPBP_ENV == 'production' && !(is_user_logged_in())) {
